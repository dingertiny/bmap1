		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li id="schooldisplay"><a href="#">显示学校</a></li>
				</ul>
...
<!-- 	<div class="navbar-text" id="currenttime"></div>
	...
	<div class="navbar-text"><a href="/bmap/index.php/Home/Login/doLogout">退出</a></div> -->
	<div class="navbar-text navbar-right" style="display:inline-flex">
		...
		<div style="margin-right:15px"><a href="/bmap/index.php/Home/Login/doLogout">退出</a></div>
	</div>
